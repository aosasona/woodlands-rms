...
<div>
  ...
  <div class="h-96 border border-t-0 border-brand-grey">
    <ul class="uk-list uk-list-divider uk-overflow-auto" id="staff-list">
      ...
      <li class="flex justify-between items-center px-3 pt-2 pb-1 m-0 select-none" data-staff-id="<?= $staff->id ?>">
        <div class="space-x-2">
          <input type="checkbox" class="uk-checkbox" name="tutors[]" value="<?= $staff->id ?>" />
